...
<div class="container-fluid">
  <div class="row">
    <!-- Sidebar -->
    <aside class="col-md-3 col-lg-2 min-vh-100 p-0 shadow-sm" style="background-color: #DC3545;">
      ...
      <nav class="nav flex-column px-3 pt-3">
        ...
        <a href="/sejarah" class="nav-link text-white mb-2">
        ...
        <div class="col-md-4">
          <div class="card text-center shadow-sm">
            <div class="card-body">
              ...
              <a href="/video" class="btn btn-danger btn-sm text-white">Detail</a>
            </div>
          </div>
        </div>
      </div>
